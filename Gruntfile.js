// Generated on 2014-12-14 using generator-ionic 0.6.1
'use strict';
  ...
  grunt.initConfig({
    ...
    ngconstant: {
      options: {
        ...
        wrap: '"use strict";\n\n {%= __ngModule %}',
        name: 'config',
        dest: '<%= yeoman.app %>/utils/config.js'
      },
      development: {
        constants: {
          ENV: {
    ...
    watch: {
      ...
      js: {
        files: ['<%= yeoman.app %>/**/*.js', '!<%= yeoman.app %>/<%= yeoman.lib %>/**/*'],
...
//        javascriptsDir: '<%= yeoman.app %>/<%= yeoman.scripts %>',
  ...
  // Since Apache Ripple serves fonts directly out of their respective platform
  // directories, we watch all registered files and then copy all un-built fonts
  ...
  grunt.registerTask('watch:karma', function () {
    var karma = {
      files: ['<%= yeoman.app %>/**/*.js', 'test/spec/**/*.js', '!<%= yeoman.app %>/<%= yeoman.lib %>/**/*'],
